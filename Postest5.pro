/* Perbedaan data object sederhana dan jamak?
Jawab:
Data Object Sederhana terbagi ada dua bagian yaitu Variabel (huruf capital atau dengan sebuah underscore _) dan Constanta (apapun yang diidentifikasikan
sebaagai sebuah object yang nilainya bisa bervariasi), sedangkan
Data Object Jamak memperlakukan beberapa informasi sebagai sebuah item tunggal, data object
dimulai dengan sebuah nama yang biasa disebut functor yang diikuti oleh tiga argumen. Functor
tidak melakukan apa-apa, hanya sebuah nama yang mengidentifikasi sebuah jenis data objek jamak
yang didalamnya terdapat argument. */
DOMAINS
...
nondeterm matakuliah(nama_matkul,nama_dosen,program_studi,ruang)matakuliah_yang_diajarkan_pada_semester_tersebut(nama_matkul,nama_mahasiswa,ruang,nama_dosen)
